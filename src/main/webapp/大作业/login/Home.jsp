...
<main class="content">
    ...
    <section id="home">
        ...
        <div class="image-container">  <!-- 这样才能实现每一个图片都有三角形效果 -->
            <a href="首页.html"><img src="../images/1.png" width="15%" height="15%"></a>
        ...
        <div class="image-container">
            <a href="首页.html"><img src="../images/2.png" width="15%" height="15%"></a>
            <p>抖音热歌：一夜爆火首首好听</p>
            <div class="triangle"></div> <!-- 三角形 -->
        </div>
        <div class="image-container">
            <a href="首页.html"><img src="../images/3.png" width="15%" height="15%"></a>
            <div class="triangle"></div> <!-- 三角形 -->
            <p>抖音热歌：一夜爆火首首好听</p>
        </div>
        <div class="image-container">
            <a href="首页.html"><img src="../images/4.png" width="15%" height="15%"></a>
            <div class="triangle"></div> <!-- 三角形 -->
            <p>抖音热歌：一夜爆火首首好听</p>
        </div>
        <div class="image-container">
            <a href="首页.html"><img src="../images/5.png" width="15%" height="15%"></a>
            <div class="triangle"></div> <!-- 三角形 -->
            <p>抖音热歌：一夜爆火首首好听</p>
        </div>
